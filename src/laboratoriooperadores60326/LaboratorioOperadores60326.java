 ...
 */
package laboratoriooperadores60326;

/**
 *
 * @author Jun
 */
public class LaboratorioOperadores60326 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("¡Hemos estado utilizando el operador " + "Asignación desde el principio! ¿Lo habias notado?");
        x = 10;
        y = 10;
        x += 20;
        y = y + 20;
